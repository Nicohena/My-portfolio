...
vec2 Y=vec2(5e-3,6.28318530718/angRings);vec2 c0=sceneC(C,r);
vec2 cdx=sceneC(C+vec2(1.0,0.0),r);vec2 cdy=sceneC(C+vec2(0.0,1.0),r);
...
const Lightfall = ({
  ...
  mouseInteraction = true, mouseStrength = 0.5,
  mouseRadius = 1, mouseDampening = 0.15, mixBlendMode
}) => {
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uColorCount: { value: count }, uBgColor: { value: hexToRGB(backgroundColor) },
      uMouseColor: { value: avg }, uSpeed: { value: speed },
